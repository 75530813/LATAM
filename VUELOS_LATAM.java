...
public class VUELOS_LATAM {
    ...
    private static int seleccionTarifa,dia,mes,hora,mes_vuelta,dia_vuelta,hora_vuelta,res_equipaje,cant_total_pas;
    Scanner sc = new Scanner(System.in);
    private static double costo_mas_equi,precio_total_pas,sprecio_total_pas;
    public String iniciarProceso() {

        this.seleccionarOrigen();
        this.seleccionarDestino();
        this.SELECCION_FECHA();
        System.out.println("Ahora seleccione una tarifa para su equipaje porfavor");
        this.INFO_TARIFAS();
        this.seleccionarTarifa();
        this.más_equipaje();
        this.ingresarDatosPasajero();
        this.seleccionarAsientos();
    ...
    public String  seleccionarMetodoPago() {
        ...
        if (metodoPago >= 1 && metodoPago <= 2) {
            ...
            System.out.println("Código de seguridad (CVV)...(3 díditos): ");
            int cvv = sc.nextInt();
